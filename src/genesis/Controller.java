...
public class Controller {
    ...
    private HashMap<String, String> controllerChangeInstanciation, controllerWhereInstanciation,
            controllerWhereIdInstanciation, controllerForeignInstanciation;
    ...
    public HashMap<String, String> getControllerWhereIdInstanciation() {
        return controllerWhereIdInstanciation;
    }

    public void setControllerWhereIdInstanciation(HashMap<String, String> controllerWhereIdInstanciation) {
        this.controllerWhereIdInstanciation = controllerWhereIdInstanciation;
    }
