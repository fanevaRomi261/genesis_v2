...
public class Language {
    ...
    public String generateController(Entity entity, Database database, Credentials credentials, String projectName)
        ...
        String changeInstanciation, whereInstanciation, whereIdInstanciation, foreignList, foreignInclude;
        for (ControllerMethod m : getController().getControllerMethods()) {
            ...
            whereIdInstanciation = "";
            whereIdInstanciation += getController().getControllerWhereIdInstanciation().get("template");
            whereIdInstanciation = whereIdInstanciation.replace("[content]",
                    "[value]");
            whereIdInstanciation = whereIdInstanciation.replace("[value]",
                    getController().getControllerWhereIdInstanciation().get("value"));
            ...
            methods = methods.replace("[controllerWhereIdInstanciation]", whereIdInstanciation);
